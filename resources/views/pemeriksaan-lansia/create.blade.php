...
@section('content')
    <h1 class="text-3xl font-bold mb-6">Tambah Data Pemeriksaan Push</h1>

    <!-- Form Tambah Data Pemeriksaan Push -->
    <form action="{{ route('pemeriksaan-lansia.store') }}" method="POST">
        @csrf

        <input type="hidden" name="data_lansia_id" value="{{ $dataLansia->id }}">
        ...
        <div class="mt-6">
            ...
            <a href="{{ route('data-lansia.show', $dataLansia->id) }}"
