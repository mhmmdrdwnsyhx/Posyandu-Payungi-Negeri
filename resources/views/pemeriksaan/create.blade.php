...
@section('content')
    <h1 class="text-3xl font-bold mb-4">Tambah Pemeriksaan</h1>
    ...
    <form action="{{ route('pemeriksaan.store', ['nama' => $dataAnak->nama]) }}" method="POST">
        @csrf
        ...
        <div class="mb-4">
            <label for="gizi" class="block text-gray-700">PMT</label>
            <input type="text" id="gizi" name="gizi"
                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                required>
        </div>
        <div class="mb-4">
            <label for="imunisasi" class="block text-gray-700">Imunisasi</label>
            <input type="text" id="imunisasi" name="imunisasi"
                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                required>
        </div>
        <div class="mb-4">
